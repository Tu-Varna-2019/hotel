...
export { default as FigUpdateRegistration } from "./FigUpdateRegistration";
export { default as FigUpdateRoom } from "./FigUpdateRoom";
export { default as FigUpdateUser } from "./FigUpdateUser";
